...
> **Fork notice:** This list is retained from upstream [Zed](https://github.com/zed-industries/zed) (Zed Industries, Inc.) for reference. The **CueCode** distribution built from [CueCard-AI/CueCode-IDE](https://github.com/CueCard-AI/CueCode-IDE) is a separate product; see the repository [README](../README.md) and [LICENSE-GPL](../LICENSE-GPL) for licensing and attribution.
