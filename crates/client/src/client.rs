...
pub mod user;
pub mod app_urls;
pub mod cuecode_urls;

/// Deprecated alias for [`cuecode_urls`].
pub use cuecode_urls as zed_urls;
...
impl ClientCredentialsProvider {
    pub fn new(cx: &App) -> Self {
        Self {
            provider: cuecode_credentials_provider::global(cx),
        }
    }
...
/// prefix for legacy zed:// url scheme
pub use app_urls::ZED_URL_SCHEME;
...
pub fn parse_zed_link(link: &str, cx: &App) -> Option<ZedLink> {
    ...
    let path = link
        ...
        .or_else(|| app_urls::strip_app_url_prefix(link))?;
