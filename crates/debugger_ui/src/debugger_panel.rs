...
use cuecode_actions::debug_panel::ToggleFocus;
    ...
    pub(crate) fn top_controls_strip(
        ...
        let edit_debug_json_button = || {
            IconButton::new("debug-edit-debug-json", IconName::Code)
                ...
                .on_click(|_, window, cx| {
                    window.dispatch_action(cuecode_actions::OpenProjectDebugTasks.boxed_clone(), cx);
                })
        ...
        let documentation_button = || {
            IconButton::new("debug-open-documentation", IconName::CircleHelp)
                .icon_size(IconSize::Small)
                .on_click(move |_, _, cx| cx.open_url("https://cuecode.dev/docs/debugger"))
                    ...
                    let welcome_experience = v_flex()
                            ...
                            Button::new("edit-debug-settings", "Edit debug.json")
                                ...
                                .on_click(|_, window, cx| {
                                    window.dispatch_action(
                                        cuecode_actions::OpenProjectDebugTasks.boxed_clone(),
                                        cx,
                                    );
                                }),
                        )
                        .child(
                            Button::new("open-debugger-docs", "Debugger Docs")
                                ...
                                .on_click(|_, _, cx| cx.open_url("https://cuecode.dev/docs/debugger")),
                        )
                        .child(
                            Button::new(
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(
                                    cuecode_actions::Extensions {
                                        category_filter: Some(
                                            cuecode_actions::ExtensionCategoryFilter::DebugAdapters,
                                        ),
                                        id: None,
                                    }
                                    .boxed_clone(),
