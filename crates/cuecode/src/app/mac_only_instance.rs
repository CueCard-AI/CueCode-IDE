...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "CueCode Dev Instance Running",
        ReleaseChannel::Nightly => "CueCode Nightly Instance Running",
        ReleaseChannel::Preview => "CueCode Preview Instance Running",
        ReleaseChannel::Stable => "CueCode Instance Running",
    }
}
