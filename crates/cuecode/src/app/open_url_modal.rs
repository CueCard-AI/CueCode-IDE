...
impl OpenUrlModal {
    pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        let editor = cx.new(|cx| {
            ...
            editor.set_placeholder_text("cuecode://...", window, cx);
            editor
        });
    ...
    fn confirm(&mut self, _: &menu::Confirm, window: &mut Window, cx: &mut Context<Self>) {
        ...
        // Handle cuecode:// and legacy zed:// URLs internally.
        if client::app_urls::is_app_deep_link(&url) || url.starts_with("zed-cli://") {
