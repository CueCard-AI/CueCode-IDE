...
use cuecode_actions::{debug_panel, dev};

pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    use cuecode_actions::Quit;

    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            cuecode_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            cuecode_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            cuecode_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            cuecode_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", cuecode_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action(format!("About {APP_NAME}"), cuecode_actions::About),
                MenuItem::separator(),
                MenuItem::submenu(Menu::new("Settings").items([
                    MenuItem::action("Open Settings", cuecode_actions::OpenSettings),
                    MenuItem::action("Open Settings File", super::OpenSettingsFile),
                    MenuItem::action("Open Project Settings", cuecode_actions::OpenProjectSettings),
                    MenuItem::action("Open Project Settings File", super::OpenProjectSettingsFile),
                    MenuItem::action("Open Default Settings", super::OpenDefaultSettings),
                    MenuItem::separator(),
                    MenuItem::action("Open Keymap", cuecode_actions::OpenKeymap),
                    MenuItem::action("Open Keymap File", cuecode_actions::OpenKeymapFile),
                    MenuItem::action("Open Default Key Bindings", cuecode_actions::OpenDefaultKeymap),
                    MenuItem::separator(),
                    MenuItem::action(
                        "Select Theme...",
                        cuecode_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        "Select Icon Theme...",
                        cuecode_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", cuecode_actions::Extensions::default()),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Open Recent…", cuecode_actions::OpenRecent::default()),
                MenuItem::action("Open Remote…", cuecode_actions::OpenRemote::default()),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", cuecode_actions::command_palette::Toggle),
                MenuItem::separator(),
                MenuItem::action("Go to File...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("Go to Symbol in Project", project_symbols::Toggle),
                MenuItem::action(
                    "Go to Symbol in Editor...",
                    cuecode_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    cuecode_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                ...
                MenuItem::action("Edit debug.json...", cuecode_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", cuecode_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", cuecode_actions::OpenLicenses),
                MenuItem::action("Show Welcome", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action("File Bug Report...", cuecode_actions::feedback::FileBugReport),
                MenuItem::action("Request Feature...", cuecode_actions::feedback::RequestFeature),
                MenuItem::action("Email Us...", cuecode_actions::feedback::EmailSupport),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: release_channel::docs_url("getting-started", cx).into(),
                    },
                ),
                MenuItem::action("Source Repository", feedback::OpenSourceRepo),
            ],
        },
    ]
}
