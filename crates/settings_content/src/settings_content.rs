...
pub struct SettingsContent {
    ...
    /// Configuration of audio in CueCode.
    ...
    /// This base keymap settings adjusts the default keybindings in CueCode to be similar
    /// to other common code editors. By default, CueCode's keymap closely follows VSCode's
    ...
    // Settings related to calls in CueCode
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in CueCode.
...
/// diagnostic data about a running CueCode instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of CueCode's default settings, ignoring user customizations.
    Default,
}
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using CueCode with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across CueCode sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and CueCode
    ///
    /// Default: true
...
/// Configuration of voice calls in CueCode.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file CueCode had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files CueCode had indexed
    Indexed,
...
pub struct RemoteSettingsContent {
    ...
    ///
    /// When unset, CueCode auto-detects BuildKit by probing for the `buildx` CLI
...
pub struct SshConnection {
    ...
    // By default CueCode will download the binary to the host directly.
    // If this is set to true, CueCode will download the binary to your local machine,
