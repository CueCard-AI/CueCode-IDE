...
pub struct ProjectSettingsContent {
    ...
    /// Whether to disable all AI features in CueCode.
    ///
    /// Default: false
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in CueCode.
    /// Default: true
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in CueCode.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary CueCode should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, CueCode will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
