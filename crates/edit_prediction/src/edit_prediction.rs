...
impl EditPredictionStore {
    ...
    pub fn new(client: Arc<Client>, user_store: Entity<UserStore>, cx: &mut Context<Self>) -> Self {
        ...
        let credentials_provider = cuecode_credentials_provider::global(cx);
        ...
        match self.edit_prediction_model {
            ...
            EditPredictionModel::Zeta => {
                edit_prediction_types::EditPredictionIconSet::new(IconName::EditPredict)
                    .with_disabled(IconName::EditPredictDisabled)
                    .with_up(IconName::EditPredictUp)
                    .with_down(IconName::EditPredictDown)
                    .with_error(IconName::EditPredictError)
            }
    ...
    fn queue_prediction_refresh(
        ...
        let (needs_acceptance_tracking, max_pending_predictions) =
            match all_language_settings(None, cx).edit_predictions.provider {
                EditPredictionProvider::CueCode | EditPredictionProvider::Mercury => (true, 2),
...
#[derive(Error, Debug)]
#[error(
    "You must update to CueCode version {minimum_version} or higher to continue using edit predictions."
)]
...
pub fn init(cx: &mut App) {
    cx.observe_new(move |workspace: &mut Workspace, _, _cx| {
        workspace.register_action(
            move |workspace, _: &cuecode_actions::OpenEditPredictionOnboarding, window, cx| {
