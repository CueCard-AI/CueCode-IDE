...
use cuecode_actions::OpenRemote;
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        children.push(
            h_flex()
                ...
                .when(!project::DisableAiSettings::get_global(cx).disable_ai, |this| {
                    this.child(
                        IconButton::new("titlebar-arrange-workspace", IconName::Split)
                            .icon_size(IconSize::Small)
                            .tooltip(Tooltip::text("Arrange Workspace"))
                            .on_click(|_, window, cx| {
                                window.dispatch_action(
                                    cuecode_actions::ArrangeWorkspace.boxed_clone(),
                                    cx,
                                );
                            }),
                    )
    ...
    fn render_project_name(
        ...
        PopoverMenu::new("recent-projects-menu")
            ...
            .trigger_with_tooltip(
                ...
                move |_window, cx| {
                    Tooltip::for_action("Recent Projects", &cuecode_actions::OpenRecent::default(), cx)
                },
            )
            .anchor(gpui::Anchor::TopLeft)
            .into_any_element()
            ...
            PopoverMenu::new("worktree-picker-menu")
                ...
                .trigger_with_tooltip(
                    ...
                    move |_window, cx| {
                        Tooltip::with_meta(
                            "Worktree",
                            Some(&cuecode_actions::git::Worktree),
            ...
            settings.show_branch_name.then(|| {
                ...
                PopoverMenu::new("branch-menu")
                    ...
                    .trigger_with_tooltip(trigger, move |_window, cx| {
                        ...
                        Tooltip::with_meta(
                            "Branch & Stash",
                            Some(&cuecode_actions::git::Branch),
                            meta,
                            cx,
                        )
                    })
        ...
        match status {
            ...
            client::Status::UpgradeRequired => {
                ...
                let label = match auto_updater.map(|auto_update| auto_update.read(cx).status()) {
                    Some(AutoUpdateStatus::Updated { .. }) => "Please restart CueCode to Collaborate",
                    Some(AutoUpdateStatus::Installing { .. })
                    | Some(AutoUpdateStatus::Downloading { .. })
                    | Some(AutoUpdateStatus::Checking) => "Updating...",
                    Some(AutoUpdateStatus::Idle)
                    | Some(AutoUpdateStatus::Errored { .. })
                    | None => "Please update CueCode to Collaborate",
                };
                ...
                ContextMenu::build(window, cx, |menu, _, _cx| {
                    menu.when(is_signed_in, |this| {
                        ...
                        this.custom_entry(
                            ...
                            move |_, cx| {
                                let url = zed_urls::account_url(cx);
                                if !url.is_empty() {
                                    cx.open_url(&url);
                                }
                            },
                        ...
                        this.custom_entry(
                            move |_window, _cx| {
                                h_flex()
                                    ...
                                    .gap_1()
                                    .justify_between()
                                    .child(Label::new("Restart to update CueCode").color(Color::Accent))
                                    .child(
                    ...
                    .action("Settings", cuecode_actions::OpenSettings.boxed_clone())
                    .action("Keymap", Box::new(cuecode_actions::OpenKeymap))
                    .action(
                        "Themes…",
                        cuecode_actions::theme_selector::Toggle::default().boxed_clone(),
                    )
                    .action(
                        "Icon Themes…",
                        cuecode_actions::icon_theme_selector::Toggle::default().boxed_clone(),
                    )
                    .action(
                        "Extensions",
                        cuecode_actions::Extensions::default().boxed_clone(),
                    )
