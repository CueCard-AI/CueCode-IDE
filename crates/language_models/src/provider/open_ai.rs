        ...
        let api_key_section = if self.should_render_editor(cx) {
            v_flex()
                ...
                .child(Label::new(format!(
                    "To use {}'s agent with OpenAI, you need to add an API key. Follow these steps:",
                    paths::APP_NAME
                )))
                .child(
                    List::new()
                ...
                .child(
                    Label::new(format!(
                        "You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart {}.",
                        paths::APP_NAME
                    ))
        ...
        let compatible_api_section = h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Label::new(format!(
                        "{} also supports OpenAI-compatible models.",
                        paths::APP_NAME
                    ))),
            )
            .child(
                Button::new("docs", "Learn More")
                    ...
                    .on_click(move |_, _window, cx| {
                        cx.open_url(&format!(
                            "{}/ai/llm-providers#openai-api-compatible",
