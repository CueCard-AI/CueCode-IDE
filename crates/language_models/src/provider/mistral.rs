                            ...
                            for part in &tool_result.content {
                                match part {
                                    ...
                                    LanguageModelToolResultContent::Image(_) => {
                                        text_parts.push("[Tool responded with an image, but CueCode doesn't support these in Mistral models yet]".to_string());
                                    }
                                }
                            }
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(format!(
                    "To use {}'s agent with Mistral, you need to add an API key. Follow these steps:",
                    paths::APP_NAME
                )))
                .child(
                    List::new()
                ...
                .child(
                    Label::new(
                        format!("You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart CueCode."),
                    )
