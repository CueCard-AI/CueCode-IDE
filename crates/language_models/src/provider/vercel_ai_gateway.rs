    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(
                    format!(
                        "To use {}'s agent with Vercel AI Gateway, you need to add an API key. Follow these steps:",
                        paths::APP_NAME
                    ),
                ))
                .child(
                ...
                .child(
                    Label::new(format!(
                        "You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart CueCode.",
                    ))
