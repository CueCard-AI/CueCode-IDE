...
// If the cuecode binary doesn't use anything in this crate, it will be optimized away
...
#[action(namespace = cuecode, deprecated_aliases = ["zed::OpenBrowser"])]
#[serde(deny_unknown_fields)]
pub struct OpenBrowser {
    pub url: Arc<str>,
}

/// Opens a cuecode:// or legacy zed:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["cuecode::OpenZedUrl", "zed::OpenZedUrl"])]
#[serde(deny_unknown_fields)]
...
#[action(namespace = cuecode, no_json, no_register, deprecated_aliases = ["zed::ChangeKeybinding"])]
pub struct ChangeKeybinding {
    pub action: String,
}

/// Focus the agent panel Plan tab (primary planning home).
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode)]
#[serde(deny_unknown_fields)]
pub struct FocusPlan {
    /// When set, select this spec path or build phase id in Plan.
    #[serde(default)]
    pub focus_spec_path: Option<String>,
}

/// Focus the agent panel Threads surface (agent chat).
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode)]
#[serde(deny_unknown_fields)]
pub struct FocusAgentChat;

/// Focus the agent panel Terminal surface.
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode)]
#[serde(deny_unknown_fields)]
pub struct FocusTerminal;

/// Open the agent panel Threads surface in a detached OS window.
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode)]
#[serde(deny_unknown_fields)]
pub struct OpenAgentChatInNewWindow;

/// Open Layout Studio to arrange Plan, Editor, and Agent surfaces.
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode)]
#[serde(deny_unknown_fields)]
pub struct ArrangeWorkspace;

/// Opens the CueCode Planning Hub (specs, build track, organize).
#[derive(Clone, PartialEq, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["cuecode::OpenSpecBrowser"])]
#[serde(deny_unknown_fields)]
pub struct OpenPlanningHub {
    /// When set, select this spec path in the artifact list (e.g. from the pin chip).
    #[serde(default)]
    pub focus_spec_path: Option<String>,
}
...
actions!(
    ...
    [
        ...
        Quit,
        /// Restarts the application to reload settings, extensions, and UI state.
        #[action(deprecated_aliases = ["workbench.action.reloadWindow"])]
        ReloadWindow,
...
#[action(namespace = cuecode, deprecated_aliases = ["zed::Extensions"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::DecreaseBufferFontSize"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::IncreaseBufferFontSize"])]
#[serde(deny_unknown_fields)]
...
#[action(namespace = cuecode, deprecated_aliases = ["zed::OpenSettingsAt"])]
#[serde(deny_unknown_fields)]
...
/// `OpenSettingsAt` path of the LLM providers page in the settings UI.
pub const LLM_PROVIDERS_SETTINGS_PATH: &str = "llm_providers";

/// `OpenSettingsAt` path of the agent skills page in the settings UI.
pub const AGENT_SKILLS_SETTINGS_PATH: &str = "agent.skills";

/// Opens the settings UI at [`LLM_PROVIDERS_SETTINGS_PATH`].
pub fn open_llm_providers_settings() -> OpenSettingsAt {
    OpenSettingsAt {
        path: LLM_PROVIDERS_SETTINGS_PATH.to_string(),
        target: None,
    }
}
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::ResetBufferFontSize"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::DecreaseUiFontSize"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::IncreaseUiFontSize"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::ResetUiFontSize"])]
#[serde(deny_unknown_fields)]
...
#[derive(PartialEq, Clone, Default, Debug, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::ResetAllZoom"])]
#[serde(deny_unknown_fields)]
...
pub mod feedback {
    ...
    actions!(
        ...
        [
            ...
            /// Opens email client to send feedback to CueCode support.
            EmailSupport,
