//! The CueCode Rust Extension API allows you to write extensions for CueCode in Rust.
//!
//! WIT bindings still use the upstream `zed:extension` package name for compatibility
//! with existing Zed extensions; the host registers and loads them under CueCode.
