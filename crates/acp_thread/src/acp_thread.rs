...
impl AcpThread {
    ...
    pub fn set_active_spec_path(&mut self, path: Option<PathBuf>, cx: &mut Context<Self>) {
        if self.active_spec_path != path {
    ...
    pub fn set_active_ticket_id(&mut self, ticket_id: Option<String>, cx: &mut Context<Self>) {
        if self.active_ticket_id != ticket_id {
