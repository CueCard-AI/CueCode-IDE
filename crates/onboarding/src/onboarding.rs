...
use cuecode_actions::OpenOnboarding;
...
#[action(namespace = cuecode, deprecated_aliases = ["zed::ImportVsCodeSettings"])]
...
#[derive(Copy, Clone, Debug, Default, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = cuecode, deprecated_aliases = ["zed::ImportCursorSettings"])]
#[serde(deny_unknown_fields)]
...
actions!(
    ...
    [
        ...
        Finish,
        /// Sign in while in the onboarding flow (no-op in CueCode v1).
        SignIn,
        /// Open account settings (no-op in CueCode v1; no cloud account required).
        OpenAccount,
                                    ...
                                    .child(
                                        h_flex()
                                            ...
                                            .child(
                                                v_flex()
                                                    .child(
                                                        Headline::new("Welcome to CueCode")
                                                            .size(HeadlineSize::Small),
                                                    )
                                                    .child(
                                                        Label::new("Agentic coding sandbox")
                                                            .color(Color::Muted)
