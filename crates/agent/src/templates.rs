...
pub struct SystemPromptTemplate<'a> {
    ...
    pub date: String,
    /// Contents of the user-global `~/.config/cuecode/AGENTS.md` file (or the
    ...
    pub is_linux: bool,
    /// Whether the workspace has indexed `.cursor/specs/` entries.
    pub has_spec_index: bool,
    /// Compact markdown table of spec titles/paths/status for the model.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub spec_index_markdown: Option<String>,
    /// Whether the workspace has a loaded plan manifest.
    pub has_plan_index: bool,
    /// Compact build-track digest from `.cuecode/plans/project.yaml`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan_index_markdown: Option<String>,
    /// Active build-phase ticket id for this session, if any.
    #[serde(skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    fn test_system_prompt_template() {
        ...
        let template = SystemPromptTemplate {
            ...
            sandboxing: false,
            is_linux: false,
            has_spec_index: false,
            spec_index_markdown: None,
            has_plan_index: false,
            plan_index_markdown: None,
            active_ticket_id: None,
        };
        let templates = Templates::new();
        let rendered = template.render(&templates).unwrap();
        assert!(rendered.contains("You are the CueCode coding agent"));
