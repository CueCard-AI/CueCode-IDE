...
use cuecode_actions::{DecreaseBufferFontSize, IncreaseBufferFontSize, ResetBufferFontSize};
...
fn git_panel_context_menu(
    ...
    ContextMenu::build(window, cx, move |context_menu, _, _| {
        context_menu
            ...
            .action("View Stash", cuecode_actions::git::ViewStash.boxed_clone())
            .separator()
                ...
                match (style, is_push) {
                    (Toast | ToastWithLog { .. }, true) => {
                        this.action("Create Pull Request", move |window, cx| {
                            window
                                .dispatch_action(Box::new(cuecode_actions::git::CreatePullRequest), cx);
                        })
                    }
                    (Toast, false) => this,
                ...
                panel_editor_container(window, cx)
                    ...
                    .child(
                        div()
                            ...
                            .pr_2p5()
                            .on_action(|&cuecode_actions::editor::MoveUp, _, cx| {
                                cx.stop_propagation();
                            })
                            .on_action(|&cuecode_actions::editor::MoveDown, _, cx| {
                                cx.stop_propagation();
                            })
...
impl RenderOnce for PanelRepoFooter {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let branch_selector_button = Button::new("branch-selector", branch_name)
            ...
            .truncate(true)
            .on_click(|_, window, cx| {
                window.dispatch_action(cuecode_actions::git::Switch.boxed_clone(), cx);
            });
        ...
        let branch_selector = PopoverMenu::new("popover-button")
            ...
            .trigger_with_tooltip(
                ...
                Tooltip::for_action_title("Switch Branch", &cuecode_actions::git::Switch),
            )
            .anchor(Anchor::BottomLeft)
            .offset(gpui::Point {
                x: px(0.0),
