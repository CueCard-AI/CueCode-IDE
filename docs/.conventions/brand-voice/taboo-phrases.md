...
```
❌ "CueCode is fast — really fast — and it shows in every interaction."
✅ "CueCode is fast. You'll feel it in every interaction."
```
...
✅ "CueCode combines editing, collaboration, and AI assistance in one workspace."
```
...
✅ "CueCode is built for speed and collaboration."
```

### Colon-Introduced Lists in Prose

```
❌ "Three things make CueCode different: speed, collaboration, and AI."
✅ "CueCode prioritizes speed, real-time collaboration, and AI integration."
```
...
✅ "CueCode renders every keystroke instantly."
```
