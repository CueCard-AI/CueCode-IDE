...
This guide helps you move from Cursor without losing muscle memory. CueCode is **not** a Cursor clone — it is a GPUI-native, agent-first fork of Zed — but you can get most day-to-day shortcuts and palette habits working quickly.
