---
title: Multibuffers - Edit Multiple Files at Once in CueCode
description: Edit multiple files simultaneously in CueCode using multibuffers. Combine with multi-cursor for fast cross-file refactoring.
---

# Multibuffers

One of the superpowers CueCode gives you is the ability to edit multiple files simultaneously. When combined with multiple cursors, this makes wide-ranging refactors significantly faster.
