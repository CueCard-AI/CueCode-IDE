---
title: Helix Mode - CueCode
description: Helix-style keybindings and modal editing in CueCode. Selection-first editing built on top of Vim mode.
---
...
CueCode's Helix mode is an emulation layer that brings Helix-style keybindings and modal editing to CueCode. It builds upon CueCode's [Vim mode](./vim.md), so much of the core functionality is shared. Enabling `helix_mode` will also enable `vim_mode`.
