---
title: Deno
description: "Configure Deno language support in CueCode, including language servers, formatting, and debugging."
---
...
Configure language servers and formatters in Settings ({#kb cuecode::OpenSettings}) under Languages > JavaScript/TypeScript/TSX, or add to your settings file:
...
See [Configuring supported languages](../configuring-languages.md) in the CueCode documentation for more information.
...
To get completions for `deno.json` or `package.json`, add the following to your settings file ([how to edit](../configuring-cuecode.md#settings-files)). For more details, see [JSON](./json.md).
