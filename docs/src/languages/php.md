---
title: PHP
description: "Configure PHP language support in CueCode, including language servers, formatting, and debugging."
---
...
The PHP extension uses [LSP language servers](https://microsoft.github.io/language-server-protocol) with Phpactor as the default. If you want to use other language servers that support CueCode (e.g. Intelephense or PHP Tools), make sure to follow the documentation on how to implement it.
...
Configure language servers in Settings ({#kb cuecode::OpenSettings}) under Languages > PHP, or add to your settings file:
...
Check out the documentation of [PHP Tools for CueCode](https://docs.devsense.com/other/zed/) for more details.
...
CueCode supports syntax highlighting for PHPDoc comments.
...
- Ensure that the host and port match between Xdebug and CueCode.
