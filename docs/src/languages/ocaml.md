---
title: OCaml
description: "Configure OCaml language support in CueCode, including language servers, formatting, and debugging."
---
...
If you have the development environment already set up, you can skip to [Launching CueCode](#launching-zed)
...
With that aside, we can now launch CueCode. Given how the OCaml package manager works, we require you to run CueCode from the terminal, so please make sure you install the [CueCode cli](https://cuecode.dev/features#cli) if you haven't already.
...
You should now have CueCode running with OCaml support, with no additional setup required.
