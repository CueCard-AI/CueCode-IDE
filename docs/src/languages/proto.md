---
title: Proto
description: "Configure Proto language support in CueCode, including language servers, formatting, and debugging."
---
...
Or you can have zed directly invoke `clang-format` by specifying it as a [formatter](https://cuecode.dev/docs/reference/all-settings#formatter) in your settings:
