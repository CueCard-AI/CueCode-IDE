---
title: Bash
description: "Configure Bash language support in CueCode, including language servers, formatting, and debugging."
---

# Bash

Bash support is available natively in CueCode.
...
- [CueCode Docs: Language Support: Shell Scripts](./sh.md)
