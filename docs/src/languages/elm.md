---
title: Elm
description: "Configure Elm language support in CueCode, including language servers, formatting, and debugging."
---
...
CueCode support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
