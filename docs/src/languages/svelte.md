---
title: Svelte
description: "Configure Svelte language support in CueCode, including language servers, formatting, and debugging."
---
...
When inlay hints are enabled in CueCode, to make the language server send them back, CueCode sets the following initialization options:
