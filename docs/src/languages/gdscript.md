---
title: GDScript
description: "Configure GDScript language support in CueCode, including language servers, formatting, and debugging."
---

# GDScript

Godot [GDScript](https://gdscript.com/) language support in CueCode is provided by the community-maintained [GDScript extension](https://github.com/GDQuest/zed-gdscript).
...
2. Open any \*.gd file through Godot and CueCode will launch.
