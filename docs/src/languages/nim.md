---
title: Nim
description: "Configure Nim language support in CueCode, including language servers, formatting, and debugging."
---

# Nim

Nim language support in CueCode is provided by the community-maintained [Nim extension](https://github.com/foxoman/zed-nim).
...
Configure formatting in Settings ({#kb cuecode::OpenSettings}) under Languages > Nim, or add to your settings file:
