---
title: Kotlin
description: "Configure Kotlin language support in CueCode, including language servers, formatting, and debugging."
---

# Kotlin

Kotlin language support in CueCode is provided by the community-maintained [Kotlin extension](https://github.com/zed-extensions/kotlin).
