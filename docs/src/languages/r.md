---
title: R
description: "Configure R language support in CueCode, including language servers, formatting, and debugging."
---

# R

R support is available via multiple R CueCode extensions:
...
3. Install the [R](https://github.com/ocsmit/zed-r) extension through CueCode's extensions manager for basic R language support (syntax highlighting, tree-sitter support) and for [REditorSupport/languageserver](https://github.com/REditorSupport/languageserver) support.

4. Install the [Air](https://posit-dev.github.io/air/) extension through CueCode's extensions manager for R code formatting via Air.
...
[Air](https://posit-dev.github.io/air/) provides code formatting for R, including support for format-on-save. The [Air documentation for CueCode](https://posit-dev.github.io/air/editor-zed.html) contains the most up-to-date advice for running Air in CueCode.

Ensure that you have installed both the [ocsmit/zed-r](https://github.com/ocsmit/zed-r) extension (for general R language awareness in CueCode) and the [Air](https://posit-dev.github.io/air/) extension.

Configure language servers in Settings ({#kb cuecode::OpenSettings}) under Languages > R, or add to your settings file:
...
If you use the `"r_language_server"` from `REditorSupport/languageserver`, but would still like to use Air for formatting, configure in Settings ({#kb cuecode::OpenSettings}) under Languages > R, or add to your settings file:
...
You can configure the [R languageserver settings](https://github.com/REditorSupport/languageserver#settings) via CueCode Project Settings `.zed/settings.json` or CueCode user settings `~/.config/cuecode/settings.json`:
...
To use the CueCode REPL with R you need to install [Ark](https://github.com/posit-dev/ark), an R Kernel for Jupyter applications.
