---
title: Luau
description: "Configure Luau language support in CueCode, including language servers, formatting, and debugging."
---
...
Luau language support in CueCode is provided by the community-maintained [Luau extension](https://github.com/4teapo/zed-luau).
...
Configuration instructions are available in the [Luau CueCode extension README](https://github.com/4teapo/zed-luau).
...
Configure formatting in Settings ({#kb cuecode::OpenSettings}) under Languages > Luau, or add to your settings file:
