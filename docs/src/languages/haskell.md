---
title: Haskell
description: "Configure Haskell language support in CueCode, including language servers, formatting, and debugging."
---
...
If you need to configure haskell-language-server (hls) you can add configuration options to your CueCode settings.json:
