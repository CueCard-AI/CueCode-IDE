---
title: Erlang
description: "Configure Erlang language support in CueCode, including language servers, formatting, and debugging."
---
...
Configure language servers in Settings ({#kb cuecode::OpenSettings}) under Languages > Erlang, or add to your settings file:
