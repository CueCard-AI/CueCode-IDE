---
title: Julia
description: "Configure Julia language support in CueCode, including language servers, formatting, and debugging."
---

# Julia

Julia language support in CueCode is provided by the community-maintained [Julia extension](https://github.com/JuliaEditorSupport/zed-julia).
