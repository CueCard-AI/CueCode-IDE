---
title: Helm
description: "Configure Helm language support in CueCode, including language servers, formatting, and debugging."
---

# Helm

Support for Helm in CueCode is provided by the community-maintained [Helm extension](https://github.com/cabrinha/helm.zed).
