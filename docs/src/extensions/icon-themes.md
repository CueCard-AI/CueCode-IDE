---
title: Icon Themes
description: "Icon Themes for CueCode extensions."
---

# Icon Themes

Extensions may provide icon themes to change the icons CueCode uses for folders and files.
...
Each icon theme file should adhere to the JSON schema specified at [`https://cuecode.dev/schema/icon_themes/v0.3.0.json`](https://cuecode.dev/schema/icon_themes/v0.3.0.json).

Here is an example icon theme structure:

```json [icon-theme]
{
  "$schema": "https://cuecode.dev/schema/icon_themes/v0.3.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
