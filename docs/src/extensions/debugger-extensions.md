...
description: "Debugger Extensions for CueCode extensions."
---
...
CueCode offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on CueCode's site](https://cuecode.dev/extensions?filter=debug-adapters).
