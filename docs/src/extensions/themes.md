---
title: Themes
description: "Themes for CueCode extensions."
---
...
Each theme file should adhere to the JSON schema specified at [`https://cuecode.dev/schema/themes/v0.2.0.json`](https://cuecode.dev/schema/themes/v0.2.0.json).

See [this blog post](https://cuecode.dev/blog/user-themes-now-in-preview) for additional background on creating themes.

## Theme JSON Structure

The structure of a CueCode theme is defined in the [CueCode Theme JSON Schema](https://cuecode.dev/schema/themes/v0.2.0.json).

A CueCode theme consists of a Theme Family object including:
...
This tool lets you fine-tune and preview how surfaces in CueCode will look.
You can then export the JSON and publish it in CueCode's extension store.
