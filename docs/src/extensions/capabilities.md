...
description: "Extension Capabilities for CueCode extensions."
---

# Extension Capabilities

The operations that CueCode extensions are able to perform are governed by a capability system.
