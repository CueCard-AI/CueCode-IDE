---
title: Collaboration
description: "Real-time collaboration in CueCode: share projects, edit code together, and communicate with voice chat."
---

# Collaboration {#collaboration}

CueCode supports real-time multiplayer editing. Multiple people can work in the same project simultaneously, seeing each other's cursors and edits as they happen.
...
See the [Data and Privacy FAQs](https://cuecode.dev/faq#data-and-privacy) for more details.
...
1. Open {#kb cuecode::OpenSettings}
...
Changes take effect immediately. If you select a device that becomes unavailable, CueCode falls back to system defaults.
