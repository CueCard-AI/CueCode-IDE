...
description: "Add contacts and start private collaboration sessions in CueCode."
---
...
1. Search for the contact using their GitHub handle.\
   _Note: Your contact must be an existing CueCode user who has completed the GitHub authentication sign-in flow._
