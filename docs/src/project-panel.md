---
title: Project Panel - CueCode
description: Navigate workspace files and directories with CueCode's project panel. Create, rename, trash and delete files and directories.
---
...
![Project Panel](../assets/images/project-panel/panel.png)
...
![Project Panel: Sticky Scroll Enabled](../assets/images/project-panel/sticky-scroll-true.png)

![Project Panel: Sticky Scroll Disabled](../assets/images/project-panel/sticky-scroll-false.png)
...
![Project Panel: Auto Fold Directories Enabled](../assets/images/project-panel/auto-fold-dirs-true.png)

![Project Panel: Auto Fold Directories Disabled](../assets/images/project-panel/auto-fold-dirs-false.png)
...
![Project Panel: Compare Marked Files](../assets/images/project-panel/compare-marked-files.png)
...
When pasting would create a name conflict, CueCode appends a "copy" suffix (e.g.,
...
![Project Panel: Git Integration](../assets/images/project-panel/git-status.png)
