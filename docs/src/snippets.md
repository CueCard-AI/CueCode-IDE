---
title: Snippets - CueCode
description: Create and use code snippets in CueCode with tab stops, placeholders, variables, and language-scoped triggers.
---
...
The snippets are located in `~/.config/cuecode/snippets` directory to which you can navigate with the {#action snippets::OpenFolder} action.
