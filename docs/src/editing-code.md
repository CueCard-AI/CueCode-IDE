---
title: Editing Code in CueCode
description: Core code editing features in CueCode including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

CueCode provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
...
When you're editing code, CueCode combines input from multiple sources:
