...
# Language Support in CueCode

CueCode supports hundreds of programming languages and text formats.
Some work out-of-the-box and others rely on 3rd party extensions.

> The ones included out-of-the-box, natively built into CueCode, are marked with \*.
...
- [Rust](./languages/rust.md) \* (CueCode's written in Rust)
