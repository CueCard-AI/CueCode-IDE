---
title: Inline AI Code Editing - CueCode
description: Transform code inline with AI in CueCode. Send selections to any LLM for refactoring, generation, or editing with multi-cursor support.
---
...
1. [using CueCode-hosted models](../account/zed-hosted-models.md), so you have access to models billed through CueCode
...
[External Agents](./external-agents.md) run in agent threads, but they are not available for Inline Assistant generations. The Inline Assistant uses CueCode-configured [LLM providers](./llm-providers.md), including CueCode-hosted models, provider API keys, gateways, local models, and supported subscriptions.
...
Here's how you can customize your settings file ([how to edit](../configuring-cuecode.md#settings-files)) to add this functionality:
...
- **[Edit Prediction](./edit-prediction.md)**: CueCode automatically suggests edits based on your recent changes, visited files, and cursor position. No prompting required.
