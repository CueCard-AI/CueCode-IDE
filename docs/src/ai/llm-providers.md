---
title: LLM Providers - CueCode
description: Choose how CueCode gets language models: CueCode-hosted models, API access, subscriptions, gateways, or local models.
---

# LLM Providers

Use this page to choose which models power [the CueCode Agent](./cuecode-agent.md) and
other CueCode-owned AI features, including [Inline Assistant](./inline-assistant.md),
...
| ----------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------- |
| [Use CueCode-Hosted Models](../account/zed-hosted-models.md)          | You want models billed through CueCode                                    | Account & Billing > CueCode-Hosted Models |
...
the difference between the CueCode Agent, External Agents, and Terminal Threads.

## Edit Prediction {#edit-prediction}

[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed CueCode AI features such as CueCode Agent, Inline Assistant, Git commit generation, and thread summaries.
