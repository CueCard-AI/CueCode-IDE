---
title: Extensions
description: "Extend CueCode with themes, language support, AI tools, and more through the extension system."
---

# Extensions

CueCode lets you add new functionality using user-defined extensions.
