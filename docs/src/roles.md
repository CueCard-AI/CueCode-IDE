---
title: Roles - CueCode
description: Understand CueCode's organization roles and what each role can access, manage, and configure.
---

# Roles

Every member of a CueCode organization is assigned a role that determines what they
...
- Disable CueCode's collaborative features
- Control whether members can use CueCode-hosted models and CueCode's edit predictions
...
CueCode-hosted AI models or Edit Predictions through the Business subscription.
...
Members have standard access to CueCode through the Business subscription. They
cannot access billing or organization settings.

## Managing User Roles {#managing-users}

Owners and Admins can manage organization members from the CueCode dashboard within
the Members page.
...
Removing a member removes their access to organization settings and any organization-managed features. They can continue using CueCode on their own.
