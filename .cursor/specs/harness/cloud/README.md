...
services (`cloud/cuecode-harness/`). The GPL IDE (`apps/CueCode-IDE`, public shadow CueCard-AI/CueCode-IDE) is a **thin
...
|------|---------|----------|
| `apps/CueCode-IDE` (this fork) | GPL-3.0-or-later | IDE, `cuecode_cloud`, tool host, UI |
