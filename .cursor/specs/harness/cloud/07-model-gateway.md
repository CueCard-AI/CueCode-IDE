# CueHarness model gateway {#model-gateway}

> **CueCloud umbrella:** the model gateway routes LLM requests from the CueHarness turn engine to providers. Index: [README](./README.md).
