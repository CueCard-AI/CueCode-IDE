...
|-------------------|------|
| Profile selector | `apps/CueCode-IDE/crates/agent_ui/src/profile_selector.rs` |
| Manage profiles modal | `apps/CueCode-IDE/crates/agent_ui/src/agent_configuration/manage_profiles_modal.rs` |
| Builtin profiles | `apps/CueCode-IDE/crates/agent_settings/src/agent_profile.rs` |
| Default tool maps | `apps/CueCode-IDE/assets/settings/default.json` |
| ACP mode selector | `apps/CueCode-IDE/crates/agent_ui/src/mode_selector.rs` |
| Thread profile | `apps/CueCode-IDE/crates/agent/src/thread.rs` |
