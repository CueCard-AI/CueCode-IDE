...
| Doc | Purpose |
|-----|---------|
| **[phases/](./phases/)** | **28 sub-phase files — execution contract** |
...
Regenerate: `python3 CueCode-IDE/script/generate-build-phase-docs.py`
...
|------|--------------|-----------------|
| 7× project panel PNGs | `CueCode-IDE/docs/src/assets/images/project-panel/` | `docs/src/project-panel.md` |
| 3× Instruments WEBPs | `CueCode-IDE/docs/src/assets/images/troubleshooting/` | `docs/src/troubleshooting.md` |
| Asset README | `CueCode-IDE/docs/src/assets/README.md` | — |
