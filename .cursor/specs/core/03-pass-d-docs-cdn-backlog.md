...
remove dependency on Zed CDNs and stale Zed cloud URLs in `CueCode-IDE/docs/`.
...
- **Rewrite** — CueCode-specific dashboard/support URLs when they exist.  
...
| `docs/src/telemetry.md` | `hi@zed.dev` + upstream GitHub issue link (L75) — point to CueCode-IDE repo / your support |
