...
| CI | `CueCode-IDE/.github/workflows/cuecode-cloud-m0.yml` | CHP / `cuecode_cloud` crate tests |
...
## 1. GitHub Actions audit (`CueCode-IDE/.github/workflows/`)
...
| `cuecode-cloud-m0.yml` | `CueCode-IDE/.github/workflows/` | Cloud M0 crate gate |
...
## 2. Repo root vs `CueCode-IDE/` CI layout
...
**Do not** move upstream workflows out of `CueCode-IDE/` without an explicit CI fork project — that
