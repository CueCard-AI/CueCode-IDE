...
GITHUB_REPO = os.environ.get("CUECODE_GITHUB_REPO", "CueCard-AI/CueCode-IDE")
...
if __name__ == "__main__":
    ...
    release_info_str += f"    </description>\n"
    release_info_str += f"    <url>https://github.com/{GITHUB_REPO}/releases/tag/{tag}</url>\n"
    release_info_str += "</release>\n"

    channel_releases_file = f"../../crates/cuecode/resources/flatpak/release-info/{channel}"
